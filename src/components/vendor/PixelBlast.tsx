/*
 * PixelBlast, vendored from react-bits (MIT).
 * https://github.com/DavidHDev/react-bits  src/ts-default/Backgrounds/PixelBlast
 *
 * Kept unmodified apart from this note so it can be diffed against upstream.
 * Loaded lazily by Hero.tsx: this plus three and postprocessing is ~130KB
 * gzipped, more than the rest of the app, so it must not block first paint.
 */
